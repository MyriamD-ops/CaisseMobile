                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="mt-2 flex items-center">
                                ...
                                />
                                <label htmlFor="show-pin" className="ml-2 block text-sm text-gray-600">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-rose-500 to-amber-500 text-white font-semibold py-3 px-4 rounded-lg hover:from-rose-600 hover:to-amber-600 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 transition disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
