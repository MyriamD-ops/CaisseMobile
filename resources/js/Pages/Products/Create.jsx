            ...
            <main style={{ padding: '32px 24px' }}>
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <div style={{ backgroundColor: '#FFFFFF', borderRadius: '8px', padding: '32px', border: '1px solid #DEE2E6' }}>
                        <h2 style={{ fontSize: '24px', fontWeight: '600', color: '#2C3E50', marginBottom: '24px' }}>Nouveau produit</h2>

                        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            <div>
                                <label style={{ display: 'block', fontSize: '13px', fontWeight: '500', color: '#495057', marginBottom: '8px' }}>Nom du produit *</label>
                                <input type="text" value={data.nom} onChange={(e) => setData('nom', e.target.value)} placeholder="Pendentif coeur 3D" style={{ width: '100%', padding: '10px 12px', border: '1px solid #DEE2E6', borderRadius: '6px', fontSize: '14px', color: '#2C3E50', boxSizing: 'border-box' }} />
                            ...
                            <div>
                                ...
                                <textarea value={data.description} onChange={(e) => setData('description', e.target.value)} rows="4" placeholder="Dimensions, couleurs, finitions..." style={{ width: '100%', padding: '10px 12px', border: '1px solid #DEE2E6', borderRadius: '6px', fontSize: '14px', color: '#2C3E50', fontFamily: 'inherit', boxSizing: 'border-box' }} />
                            </div>

                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                <div>
                                    <label style={{ display: 'block', fontSize: '13px', fontWeight: '500', color: '#495057', marginBottom: '8px' }}>Prix (€) *</label>
                                    <input type="number" step="0.01" value={data.prix} onChange={(e) => setData('prix', e.target.value)} style={{ width: '100%', padding: '10px 12px', border: '1px solid #DEE2E6', borderRadius: '6px', fontSize: '14px', color: '#2C3E50', boxSizing: 'border-box' }} />
                                ...
                                <div>
                                    ...
                                    <select value={data.categorie} onChange={(e) => setData('categorie', e.target.value)} style={{ width: '100%', padding: '10px 12px', border: '1px solid #DEE2E6', borderRadius: '6px', fontSize: '14px', color: '#2C3E50', boxSizing: 'border-box' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                <div>
                                    ...
                                    <input type="number" value={data.stock_actuel} onChange={(e) => setData('stock_actuel', e.target.value)} style={{ width: '100%', padding: '10px 12px', border: '1px solid #DEE2E6', borderRadius: '6px', fontSize: '14px', color: '#2C3E50', boxSizing: 'border-box' }} />
                                ...
                                <div>
                                    ...
                                    <input type="number" value={data.stock_minimum} onChange={(e) => setData('stock_minimum', e.target.value)} style={{ width: '100%', padding: '10px 12px', border: '1px solid #DEE2E6', borderRadius: '6px', fontSize: '14px', color: '#2C3E50', boxSizing: 'border-box' }} />
                            ...
                            <div>
                                ...
                                <select value={data.matiere} onChange={(e) => setData('matiere', e.target.value)} style={{ width: '100%', padding: '10px 12px', border: '1px solid #DEE2E6', borderRadius: '6px', fontSize: '14px', color: '#2C3E50', boxSizing: 'border-box' }}>
                                    <option value="">Sélectionner...</option>
                                    {matieres.map(mat => <option key={mat} value={mat}>{mat}</option>)}
                                </select>
                                <p style={{ fontSize: '12px', color: '#ADB5BD', marginTop: '4px' }}>Le type de filament utilisé</p>
                            </div>

                            <div style={{ display: 'flex', gap: '12px', paddingTop: '16px', borderTop: '1px solid #DEE2E6' }}>
                                <button type="submit" disabled={processing} style={{ flex: 1, padding: '12px', backgroundColor: processing ? '#ADB5BD' : '#343A40', color: '#FFFFFF', fontWeight: '600', borderRadius: '6px', border: 'none', cursor: processing ? 'not-allowed' : 'pointer', fontSize: '14px', transition: 'all 0.2s', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                                    {processing && (
                                        <span style={{ 
                                            width: '14px', 
                                            height: '14px', 
                                ...
                                <Link href="/products" style={{ flex: 1, padding: '12px', backgroundColor: '#F8F9FA', color: '#495057', fontWeight: '600', borderRadius: '6px', border: '1px solid #DEE2E6', textAlign: 'center', textDecoration: 'none', fontSize: '14px', display: 'block', boxSizing: 'border-box' }}>
                                    Annuler
                                </Link>
                            </div>
                        </form>
